...
const OurStory = () => (
  <div
    ...
    <div className="content-wrapper">
       ...
       <p className="our-story-text">Last February we travelled back to Shanghai for our 10 year study abroad reunion. Vic proposed to Steph on The Bund the first night of their trip, with the twinkling lights of Shanghai’s waterfront skyline as the backdrop. Steph was so excited, she forgot to say “yes” - instead, she tackled Vic to the ground.</p>
       <p className="our-story-text">Fear not - Steph eventually said "yes", but Vic takes great joy in reminding her of this quite frequently.</p>
    </div>
  </div>
);
